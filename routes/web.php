...
Route::get('/pumaurl2', [TrendyolController::class, 'pumaurl2']);
Route::get('/pumaproducts2', [TrendyolController::class, 'pumaproducts2']);
Route::get('/pumaurl3', [TrendyolController::class, 'pumaurl3']);
Route::get('/pumaproducts3', [TrendyolController::class, 'pumaproducts3']);
