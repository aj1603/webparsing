...
{
    public function mavi() { ///////
        $client = new Client();
        $bershka1 = $client->request('GET', 'https://www.trendyol.com/mavi-kadin-ceket-x-b43-g1-c1030?pi=1');
        $bershka2 = $client->request('GET', 'https://www.trendyol.com/mavi-kadin-ceket-x-b43-g1-c1030?pi=2');
        $bershka3 = $client->request('GET', 'https://www.trendyol.com/mavi-kadin-ceket-x-b43-g1-c1030?pi=3');
